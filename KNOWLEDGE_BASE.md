...
| 201–237 | 37 | 混合 | 条件解锁（时段/日期/天数/收集） |
...
**称号收集:** 搜集 (≥10)、研究员 (≥20)、造物院 (≥30)、金色 (≥1 传说)、小金人 (3 传说全装)

**抽奖统计:** 重复观测 (≥1)、古典概型 (≥10)、正态分布 (≥100)、试试 (≥1)、玩 (≥10)、富有 (≥25)、上瘾 (≥50)、戒戒你好 (≥100)、大赚 (中 10)、BUG (连 3 次 0)、致命错误 (连 10 次 0)
