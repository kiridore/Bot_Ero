...
| 列 | 类型 | 约束 | 说明 |
|----|------|------|------|
| user_id | TEXT | PK (with week_key) | |
| week_key | TEXT | PK | 周一日期 |
...
| total_zeros | INTEGER | DEFAULT 0 | 累计空抽次数 |
...
| 201–265 | 65 | 混合 | 条件解锁（时段/日期/天数/收集/任务/抽奖统计） |
...
**抽奖统计:** 重复观测 (≥1)、古典概型 (≥10)、正态分布 (≥100)、试试 (≥1)、玩 (≥10)、富有 (≥25)、上瘾 (≥50)、戒戒你好 (≥100)、沉迷抽卡 (≥200)、倾家荡产 (≥500)、无底深渊 (≥1000)、抽抽乐 (≥3)、抽卡成精 (≥75)、攒着抽 (≥150)、挥金如土 (≥300)、抽穿卡池 (≥2000)、大赚 (中 10)、BUG (连 3 次 0)、致命错误 (连 10 次 0)、非气初现 (≥1 次空)、连连看 (连 5 次 0)、非酋认证 (连 15 次 0)、天命之人 (连 30 次 0)

**累计空抽:** 空 (≥1)、酋长 (≥10)、空抽 (≥50)、黑黑 (≥100)、虚空行者 (≥300)、大赚 (中 10)、BUG (连 3 次 0)、致命错误 (连 10 次 0)

**周常任务:** 任务达人 (≥5)、勤勉板油 (≥15)、劳模奖章 (≥30)、任务狂人 (≥50)
**全清周常:** 周常全清 (≥1 周全清)、任务能手 (≥3 周)、全清达人 (≥5 周)、周常大师 (≥10 周)、任务终结者 (≥20 周)
