...
| `/占卜` | 塔罗牌占卜 | 任何人 |
| `.rAdB` | 掷骰子（基础，旧版） | 任何人 |
| `.r <表达式>` | 跑团骰子表达式（例：`.r 2d6+3` `.r 4d6k3`） | 任何人 |
| `.ra <表达式>` | DND优势骰（例：`.ra d20+5`） | 任何人 |
| `.rd <表达式>` | DND劣势骰（例：`.rd d20+5`） | 任何人 |
| `.rc <技能值>` | COC技能检定（例：`.rc 70`） | 任何人 |
| `.rcb <A值> <B值>` | COC对抗检定（例：`.rcb 60 50`） | 任何人 |
| `.rh` | DND属性投点（4d6k3 ×6） | 任何人 |
