...
| `/角色 创建` `/角色 编辑 …` `/角色 放弃` | 回复引导至网页端创建/编辑（http://127.0.0.1:8765/profile/trpg） | 任何人 |
...
| `/活动 创建 接龙 <标题> [描述] [每人时限]` | 发布接龙活动（限时如 48小时/2天） | 任何人 |
| `/活动 创建 匹配 <标题> [描述] <截止时间>` | 发布匹配活动（圆桌下家） | 任何人 |
| `/活动 加入` / `/活动 退出` | 报名 / 退出活动 | 任何人 |
| `/活动 开始` | 开始活动 | 创建人/超管 |
| `/活动 状态` | 查看活动进度 | 任何人 |
| `/活动 结束` | 结束活动 | 创建人/超管 |
| `/提交 [活动id]` | （私聊）提交作品 | 活动成员 |
| `/闹钟 ...` | 闹钟管理 | 任何人 |
